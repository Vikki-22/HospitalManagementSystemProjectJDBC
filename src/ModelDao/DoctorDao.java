...
public class DoctorDao {
    ...
    public int addDoctor(Doctors d) {
        ...
        try {
            ...
            pst.setDate(6,
                    new Date(d.getHire_date().getTime()));

            pst.setInt(7,
                    d.getDepartments_id().getDepartment_id());
    ...
    public int updateDoctor(Doctors d) {
        ...
        try {
            ...
            String query =
            "update doctors set first_name=?,last_name=?,specialization=?,phone=?,email=?,hire_date=?,department_id=? where doctor_id=?";
